  ...
  (function(global, factory) {
    ...
    function locateNodeInLineView(lineView, node, offset) {
      ...
      for (var before = topNode.previousSibling,
          dist$1 = offset; before; before = before.previousSibling) {
